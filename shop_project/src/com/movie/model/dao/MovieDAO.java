...
public class MovieDAO {
	...
	public int updateRental(int no) throws SQLException {
		return sqlMap.update("movie.rentalAmount",no);
	}
	
	public void insertRental(Rental rental) throws SQLException {
		sqlMap.insert("movie.insertRental",rental);
		
	}
	
	public List<String> selectRental(String userid) throws SQLException {
		return sqlMap.queryForList("movie.selectRental",userid);
	}
	
	public int updateReturn(int rentid) throws SQLException {
		return sqlMap.update("movie.updateReturn",rentid);
	}
	
	public void returnAmount(int movieid) throws SQLException {
		sqlMap.update("movie.returnAmount",movieid);
	}
