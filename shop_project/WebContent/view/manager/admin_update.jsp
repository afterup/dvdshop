...
<body id="adminPage">
	...
	<div class="container">
		<img src="${pageContext.request.contextPath}/img/${movie.MOVIEIMG}"
			alt="${movie.MOVIENM }">
		<form action="admin?action=updateAction&no=${movie.MOVIEID }" method="POST" name="frm">
			<h1>
				<input type="text" name="movienm" value="${movie.MOVIENM }">
			</h1>
			<div class="form-group">
				<label for="genrenm">영화장르</label> <input type="text"
					value="${movie.GENRENM }" class="form-control" name="genrenm">
			</div>
			<div class="form-group">
				<label for="supervison">영화감독</label> <input type="text"
					value="${movie.SUPERVISON }" class="form-control" name="supervison">
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				<label for="moviedesc">영화설명</label> <input type="text"
					value="${movie.MOVIEDESC }" class="form-control" name="moviedesc">
			</div>
			<div class="form-group">
			...
			<button type="button" onclick="validateCheck()" class="btn btn-info">수정</button>
